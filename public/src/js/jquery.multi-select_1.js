  ...
  * ====================== */
  ...
  MultiSelect.prototype = {
    ...
    'generateLisFromOption' : function(option, index, $container){
      ...
      var $optgroup = $option.parent('optgroup'); // s il attr groupe
      if ($optgroup.length > 0){
        ...
        index = index == undefined ? this.$selectableUl.children().length : index;
       
        selectableLi.insertAt(index, this.$selectableUl); //insert to ul
        selectedLi.insertAt(index, this.$selectionUl);  //insert to ul
      }
    },
