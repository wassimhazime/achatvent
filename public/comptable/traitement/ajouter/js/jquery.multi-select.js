  ...
  MultiSelect.prototype = {
    ...
    init: function(){
     ...
     this.$selectableUl.append('<thead><tr>'+th+'</tr></thead>');
        ...
        var lengthoption=ms.find('option').length;
        var compte=0;
        ms.find('option').each(function(){
          
          that.generateLisFromOption(this,lengthoption,compte);// daba bdina
          compte++; 
        });
         this.$selectiontbody.find('tr').each(function(){$(this).addClass('active')});
    ...
    'generateLisFromOption' : function(option, lengthoption,compte,index){
      ...
      var td='';
       ...
       var tbody="",ftbody="";
//       if(compte==0){tbody="<tbody>"}
//       if(compte===lengthoption){ftbody="</tbody>"}
  ...
  $.fn.multiSelect = function () {
    ...
    return this.each(function () {
      ...
      if (typeof option === 'string'){
        OBJECTMultiSelect[option](args[1]);
      } else {
